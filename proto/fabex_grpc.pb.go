...
func (c *fabexClient) Get(ctx context.Context, in *Entry, opts ...grpc.CallOption) (Fabex_GetClient, error) {
	stream, err := c.cc.NewStream(ctx, &Fabex_ServiceDesc.Streams[0], "/fabex.Fabex/Get", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fabexClient) GetRange(ctx context.Context, in *RequestRange, opts ...grpc.CallOption) (Fabex_GetRangeClient, error) {
	stream, err := c.cc.NewStream(ctx, &Fabex_ServiceDesc.Streams[1], "/fabex.Fabex/GetRange", opts...)
	if err != nil {
		return nil, err
	}
...
func RegisterFabexServer(s grpc.ServiceRegistrar, srv FabexServer) {
	s.RegisterService(&Fabex_ServiceDesc, srv)
}
...
// Fabex_ServiceDesc is the grpc.ServiceDesc for Fabex service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var Fabex_ServiceDesc = grpc.ServiceDesc{
